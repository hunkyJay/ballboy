...
/*
 * Concrete entity factory for enemy entities.
 */
public class EnemyFactory implements EntityFactory {
    ...
    public Entity createEntity(
        ...
        try {
            ...
            String color = (String) config.get("color");//get the colour of enemy from the json config
            ...
            //set score for the R G B enemies
            int score;
            switch (color) {
                case "red":
                    score = 1;
                ...
                default:
                    score = 0;
//                    throw new ConfigurationParseException(
//                            String.format("%s is not a valid enemy colour\n", behaviour));
            }
            ...
            return new DynamicEntityImpl(
                    ...
                    collisionStrategy,
                    behaviourStrategy,
                    score//Add score to use the score required constructor
            );

        } catch (Exception e) {
            throw new ConfigurationParseException(
                    String.format("Invalid enemy entity configuration | %s | %s", config, e));
        }
    }
}
